...
SOURCEFILES_QUOTED_IF_SPACED=USART.c spi.c mainM.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/USART.p1 ${OBJECTDIR}/spi.p1 ${OBJECTDIR}/mainM.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/USART.p1.d ${OBJECTDIR}/spi.p1.d ${OBJECTDIR}/mainM.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/USART.p1 ${OBJECTDIR}/spi.p1 ${OBJECTDIR}/mainM.p1

# Source Files
SOURCEFILES=USART.c spi.c mainM.c
...
${OBJECTDIR}/mainM.p1: mainM.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/mainM.p1.d 
	@${RM} ${OBJECTDIR}/mainM.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto     -o ${OBJECTDIR}/mainM.p1 mainM.c 
	@-${MV} ${OBJECTDIR}/mainM.d ${OBJECTDIR}/mainM.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/mainM.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
